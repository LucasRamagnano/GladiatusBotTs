...
let linkSubasta ='';
let resultadosSubasta: Resultados = {gladiador:null,mercenario:null,fundicionGladiador:null,fundicionMercenario:null,guerreroMercenario:null}
interface Resultados {
	gladiador:SubastaResultado,
	mercenario:SubastaResultado,
	fundicionGladiador:SubastaResultado,
	fundicionMercenario:SubastaResultado,
	guerreroMercenario:SubastaResultado
}
...
async function init(datos: ConfiguracionStruct, tabIdActiva: number) {
...
async function initSubasta(idSubasta:string, esMercenario:boolean,resultados: SubastaResultado) {
