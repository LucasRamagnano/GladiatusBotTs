...
class ItemUtils {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                while (intentosMover <= 5 && !$(destino)[0].innerHTML.includes(item.getName())) {
                    ...
                    yield GenericUtils.wait(20000);
                    while (intentosEsperaDisabled <= 5 && $(destino).find('.disabled').length > 0) {
                        yield GenericUtils.wait(1000 + (1000 * intentosEsperaDisabled));
    ...
    static fireMouseEvent(elem, type, opt) {
        let options = {
            bubbles: true,
    ...
    static ponerHojaNumero(hoja, inventoryBox) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (inventario.length >= hoja + 1 && !inventario[hoja].classList.contains('current') && intentosCambioHoja <= 5) {
                ...
                yield GenericUtils.wait(1000 + (1000 * intentosCambioHoja));
                intentosCambioHoja++;
            }
